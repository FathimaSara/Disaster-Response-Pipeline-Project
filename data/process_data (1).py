...
def load_data(messages_filepath, categories_filepath):
    '''Loads files with messages and categories and returns dataframe
    Input: 
    message_filepath:  messages_csv
    categories_filepath: categoriess_csv
...
def save_data(df, database_filename):
    ...
    Ouput: Database saved in filepath name.'''
